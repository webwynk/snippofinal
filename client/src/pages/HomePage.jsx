...
export default function HomePage({ user, onUserAuth, onGoDash, services, staff, bookings, busySlots, onCreateBooking, embedMode = false, embedHeader = null, stripeKey, token }) {
